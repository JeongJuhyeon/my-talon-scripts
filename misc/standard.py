...
def engine_update(j):
    engine.ctrl("g.update", name="dragon", enabled=False)
...
keymap.update(
    {
        ...
        "next window": Key("ctrl-`"),
        "last window": Key("ctrl-shift-`"),
        # 'next app': Key('ctrl-tab'),
        # 'last app': Key('ctrl-shift-tab'),
        "next tab": Key("ctrl-tab"),
        "new tab": Key("ctrl-t"),
        "last tab": Key("ctrl-shift-tab"),
        "next space": Key("ctrl-alt-ctrl-right"),
        "last space": Key("ctrl-alt-ctrl-left"),
        "zoom [in]": Key("ctrl-+"),
        "zoom out": Key("ctrl--"),
